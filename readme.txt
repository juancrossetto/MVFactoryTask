For run the project -->
	In Server Project we have to change: ConnectionStrings in appsettings.json											     ApiKey in appsettings.json file (if it's caducated) 
					     AngularUrl if we use another enviroment or another port.
